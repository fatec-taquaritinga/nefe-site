...
window.addEventListener("scroll", fixed), window.onresize = fixed, abre.onclick = function() {
    innerWidth < 600 && 0 == menu ? (nav.classList.add("aberto"), abre.classList.add("fechado"), abre.setAttribute("src", "img/close.svg"), menu = 1) : innerWidth < 600 && (nav.classList.remove("aberto"), abre.classList.remove("fechado"), abre.setAttribute("src", "img/menu.svg"), menu = 0)
};
